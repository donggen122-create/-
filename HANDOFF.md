...
## 2026-09-23 저녁. 파츠 보급 개편 2차·3차 완성 / 실서버 배포 대기 (Claude)
...
- 태블릿 해상도 자동 조절 수리 포함. 검사 89/89, 브라우저 PC 1280·폰 375 통과(격리 서버). 배포는 `seoho-game`에 합친 뒤 배포 PC에서 check-live → deploy.ps1.
