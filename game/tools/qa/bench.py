...
# 사용: python game/tools/qa/bench.py --url http://localhost:8797 --label after [--devices tablet,phone,pc] [--reps 5] [--gear none|ranged|melee]
# --gear: 호야 장비 전설 6세트(특수 효과 전부 켜짐 — 장비 계산이 가장 많은 경우, 2026-09-24)
