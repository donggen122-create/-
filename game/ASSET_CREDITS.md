...
## 배경음 — 메인 테마곡 (2026-09-23 추가)

- 파일: `game/assets/audio/main-theme.mp3` (3.58MB, MP3)
- 출처: 프로젝트 주인이 제공 — 프로젝트 GitHub 저장소 `donggen122-create/-`의 `claude/blissful-gates-t7nrbc` 브랜치 `game/audio/main-theme.mp3`에서 받아 그대로 포함(수정 없음).
- 사용: 시작 화면·로비 배경음(반복 재생, `game/src/music.js`). 전투 중에는 재생하지 않는다.