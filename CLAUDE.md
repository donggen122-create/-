...
- 사용자 요청으로 docs/26의 보급 규칙(원소 고르기·5번째 3개·처음 3종·동/은/금)을 대신한다: 10종 중 무작위(전설 제외), 개수 운 1·3·7개(80/18/2%), 등급 노말 1 · 레어 3 · 유니크 7 · 에픽 25 · 전설 80개. 첫 무료 파츠만 고르기. 이름은 보급·보급권. 자세한 내용 `docs/27_파츠_보급_무작위_5등급.md`.
