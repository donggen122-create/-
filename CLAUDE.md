...
## 2026-09-23 밤. 배포 대기: 무작위 5등급 보급·어려움 재조정·훈련 100·1-5 대왕 거리별 기술 (Claude)
- 실서버는 fc20ccda. 그 뒤 seoho-game에 쌓인 것: `docs/27`(보급 무작위·노말~전설)·`docs/28`(어려움 ×5.5/×4.8, 훈련 만렙 100)·`docs/29`(대왕 거리별 기술·체력 20배). 사용자가 "배포해"라고 하면 deploy/ 브랜치로 배포.
- 대왕 기술 그림(선택): `이미지 에셋/보스_기술_그림_프롬프트.md`. 그림이 오면 자세 바꾸기·던지는 쓰레기·착지 효과를 붙인다.
