...
## 2026-09-23 밤. 다음 작업: 테마 2 「대기오염 — 공장 지대」 6~10단계 (그림 대기)
- 사용자 요청. 몬스터: 먼지몬 · 가스몬(가까이 오면 불 뿜기, 원거리 없음) · 세균몬(바닥 지뢰, 안 움직임) · 산성비 구름몬(Claude 제안, 원거리) · 엘리트 왕먼지몬 · 보스 굴뚝 가스 대왕(파이프·부속품, 근·중·원거리 기술). 원래 계획표의 테마 2 「개울」은 뒤로.
- 그림 프롬프트 9장: `이미지 에셋/테마2_대기오염_프롬프트.md`. 사용자가 이 대화에 첨부하거나 `이미지 에셋/`에 올리면 잘라서 구현한다(단계 구성·목표 밸브 잠그기도 그 문서).
